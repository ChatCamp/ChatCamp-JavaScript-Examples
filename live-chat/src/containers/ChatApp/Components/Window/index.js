...
class Window extends Component {
  ...
  render () {
    ...
    if(this.props.smartChat.get("type") === "popup"){
      popupRightAdjustment = String(345*this.props.position + 40*(this.props.position + 1)) + "px"
      mainClass = "chatcamp-popup  chatcamp-popup-customer-widget ifc-chat-window-container";

...
export const createChannel = (users) => dispatch => {
  client.GroupChannel.create("Chat with ChatCamp", users, true, function(error, groupChannel) {
    if(!error) {
      console.log("heya")
      dispatch({
      ...
      let groupChannelId = groupChannel.id
      let messageId = null
      ...
      getHistory(groupChannel.id, null)
    }
  });
}
